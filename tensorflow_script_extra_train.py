...
def start_tensorflow(paths_for_Blender, networkPrefix):
    ...
    # Save the model
    model.save(os.path.dirname(__file__)+'\\'+networkPrefix+'-Seq.h5')
    # Recreate the exact same model purely from the file
    new_model = keras.models.load_model(os.path.dirname(__file__)+'\\'+networkPrefix+'-Seq.h5')
    new_model.summary()
